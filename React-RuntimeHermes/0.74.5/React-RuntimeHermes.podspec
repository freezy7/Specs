...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"${PODS_ROOT}/React-hermes/node_modules/react-native/ReactCommon\" \"${PODS_ROOT}/hermes/executor\" \"$(PODS_ROOT)/boost\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-jsinspector/jsinspector_modern.framework/Headers\"",
                                "USE_HEADERMAP" => "YES",
